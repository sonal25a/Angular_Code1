...
@Component({
  selector: 'app-mortgage-amortization',
...
export class MortgageAmortizationComponent implements OnInit {
  ...
  public barChartData:any[] = [
    {data: [65, 59, 80, 81, 56, 55, 40], label: 'Interest Paid'},
    {data: [28, 48, 40, 19, 86, 27, 90], label: 'Prinicipal Paid'},
    {data: [28, 48, 40, 19, 86, 27, 90], label: 'Balance'}
  ];
